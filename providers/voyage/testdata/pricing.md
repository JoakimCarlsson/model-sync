---
updatedAt: 2026-08-10T21:54:38.000Z
---
...
| `voyage-context-4`                                          | $0.00018                  | $0.12                    | 200 million           |
| `voyage-code-4`                                             | $0.00018                  | $0.12                    | 200 million           |
...
Our <Anchor target="_blank" href="https://docs.voyageai.com/docs/batch-inference">Batch API</Anchor> provides a simple way to process multiple requests efficiently to our <Anchor target="_blank" href="https://docs.voyageai.com/docs/batch-inference#/model-availability">current models</Anchor>. It offers a 12-hour completion window and a **33% discount** compared to our standard endpoints.
